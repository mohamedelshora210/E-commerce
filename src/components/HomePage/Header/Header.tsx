    ...
    <>
        <div className=" h-[90dvh] flex flex-col items-center justify-center text-center overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-6 my-5">
                <Link href={'/products'} className="order-2 sm:order-1"><Button className=" duration-200 bg-teal-700 hover:scale-105 border-3 border-teal-700 hover:border-teal-800 hover:bg-teal-800 cursor-pointer text-xl px-7 py-6 animate__animated animate__fadeInDown animate__delay-3s">Shop Now</Button></Link>
                <Link href={'/categories'} className="order-1 sm:order-2"><Button className=" duration-200 bg-transparent hover:scale-105 border-3 text-teal-800 border-teal-700 hover:border-teal-800 hover:text-white hover:bg-teal-800 cursor-pointer text-xl px-7 py-6 animate__animated animate__fadeInUp animate__delay-3s">Browse Categories</Button></Link>
            </div>
        </div>
    </>
  )
